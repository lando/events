  ...
  <main class="not-found-page" aria-labelledby="not-found-title">
    <section class="not-found-content">
      ...
      <p class="not-found-copy">
        While we rebuild the hyperspace lane, you can head back to events or support the free developer tools that keep Lando orbiting.
      </p>
...
.not-found-page {
  ...
  background:
    ...
    radial-gradient(90% 80% at 90% 10%, rgba(67, 217, 255, .2) 0%, #fff 65%);
